(function () {
  ...
  function initRequestForm(form) {
    ...
    const draftWrapEl = form.querySelector('[data-role="expert-draft-wrap"]');
    const draftLoadingEl = form.querySelector('[data-role="expert-draft-loading"]');
